...
(async () => {
  ...
  try {
    ...
    const getAmt = o => { const gross = parseFloat(o.paymentAmount || o.tradeAmount || o.orderAmount || o.statPaymentAmount || o.statOrderAmount || o.totalMoney || 0); const refund = parseFloat(o.afterSalePaymentAmount || o.afterSaleTradeAmount || 0); return Math.max(0, gross - refund); };
    ...
    const getOrderAmount = o => { const gross = parseFloat(o.paymentAmount || o.tradeAmount || o.orderAmount || o.statPaymentAmount || o.statOrderAmount || o.totalMoney || 0); const refund = parseFloat(o.afterSalePaymentAmount || o.afterSaleTradeAmount || 0); return Math.max(0, gross - refund); };
